let a=["1 What do you call a boomerang that won't come back",
"A stick",
...
let array_len=a.length;
let n=(Math.floor(Math.random()*array_len));
if(n%2!=0){
    n=n-1;
}
let s =document.getElementsByTagName("blockquote")[0];
s.innerHTML=`"${a[n]}"`;
